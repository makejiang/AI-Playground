...
class MSPlaygroundDownloader:
    ...
    def enum_file_list(
        ...
        def add_file_to_list(file: dict):
        ...
        try:
            ...
            for file in repo_files:
                if file_path:
                    # download one file like "bartowski/Llama-3.2-3B-Instruct-GGUF/llama-3.2-3b-instruct.gguf"
...
def init():
    ...
    repo_id = "aiplayground/dreamshaper-8"
